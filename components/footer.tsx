  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { label: "Best Sellers", href: "/products?sortBy=reviews_count" },
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-nike-body text-lg text-nike-gray-300 max-w-2xl mx-auto">
                Get exclusive access to new releases, special offers, and
                insider updates. Join the community of champions.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                ...
                />
                <Button className="btn-nike-primary" onClick={handleSubscribe}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
            ...
            <div className="lg:col-span-1">
              ...
              >
                <Link href="/" className="flex items-center space-x-3">
                  ...
                  <span className="text-nike-display text-2xl font-bold">
                    NIKE
                  </span>
                </Link>
                <p className="text-nike-body text-nike-gray-300">
                  Just Do It. Discover the latest collection of premium
                  footwear. Engineered for performance, designed for style,
                  built for champions.
                </p>
            ...
            {footerSections.map((section, sectionIndex) => (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <h3 className="text-nike-display text-lg font-semibold mb-6">
                  {section.title}
                </h3>
        ...
        <div className="py-8 border-t border-nike-gray-800">
          ...
          >
            ...
            <div className="flex gap-8 text-sm">
              <Link
                href="/privacy"
                className="text-nike-gray-400 hover:text-nike-orange-400 transition-colors"
              >
                Privacy Policy
              </Link>
              <Link
